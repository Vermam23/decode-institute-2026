...
How do we calculate the average VO2 max at the first visit for just the control rats?

```{r, solution=TRUE}

```

How do we calculate the average VO2 max at the first visit for male and female control rats?
